% System Architecture
% -------------------------------------------------------------
% This section describes the high-level architecture of the Analytics
% Agent project. It outlines the major components, how they interact,
% and the data/state that flows between them. The implementation
% lives in a small LangGraph-based graph of Python nodes, each
% responsible for a precise piece of the pipeline.
